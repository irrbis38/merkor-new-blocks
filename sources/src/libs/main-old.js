$(document).ready(function () {
    ...
    let features = document.querySelectorAll(".features--mobile");

    if (features.length) {
        features.forEach((f) => {
            let featuresSliderContainer = f.querySelector(
                ".features-main .swiper-container"
            );

            let featuresSlide = new Swiper(featuresSliderContainer, {
                slidesPerView: 1,
                effect: "slide",
                loop: false,
                spaceBetween: 0,
            ...
            let iconsSliderContainer = f.querySelector(
                ".features-icons .swiper-container"
            );

            let iconsSlide = new Swiper(iconsSliderContainer, {
                slidesPerView: "auto",
                effect: "slide",
                loop: false,
                spaceBetween: 90,
