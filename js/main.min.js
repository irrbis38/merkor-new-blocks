...
"use strict";var initVKVideo=e=>{e.forEach(o=>{var e=o.dataset.video,i=e.substring("https://vk.com/video-".length,e.length).split("_"),s=o.parentElement;s.querySelector(".video-play-btn").addEventListener("click",()=>{r=i[0],e=i[1],(t=document.createElement("iframe")).classList.add("video-iframe"),t.setAttribute("src","https://vk.com/video_ext.php?oid=-"+r+"&id="+e+"&hd=2&autoplay=1"),t.setAttribute("frameborder","0"),t.setAttribute("allowfullscreen",""),t.setAttribute("allow","autoplay; encrypted-media; fullscreen; picture-in-picture; screen-wake-lock;");var e,t,r=t;s.querySelector(".video-preview").remove(),o.append(r)})})},objectItemInit=e=>{var t=e.querySelector(".nobjects__video_play"),r=e.querySelector(".nobjects__slider"),o=e.querySelector(".nobjects__prev"),i=e.querySelector(".nobjects__next");t&&t.addEventListener("mouseover",()=>{e.classList.add("is-hover")}),t&&t.addEventListener("mouseleave",()=>{e.classList.remove("is-hover")}),r&&new Swiper(r,{slidesPerView:1,spaceBetween:10,navigation:{prevEl:o,nextEl:i}})},modalInit=(t,e)=>{e.addEventListener("click",()=>{t.classList.add("is-active"),document.body.classList.add("lock")});e=document.querySelectorAll(".js-modal-close");0<e.length&&e.forEach(e=>{e.addEventListener("click",()=>{t.classList.remove("is-active"),document.body.classList.remove("lock")})})},initProductsGroup=()=>{var e=document.querySelector(".products__group"),t=document.querySelector(".products__group_more");e&&t&&t.addEventListener("click",()=>{e.classList.toggle("is-shown"),e.classList.contains("is-shown")?t.textContent="Скрыть":t.textContent="Показать еще"})},initCompanyWrapper=e=>{e.querySelector(".js-company-showall").addEventListener("click",()=>{e.style.maxHeight=e.scrollHeight+"px",e.classList.add("is-open"),setTimeout(()=>{e.style.maxHeight="none"},300)})},reviewsSliderInit=e=>{var t=e.querySelector(".js-prev-btn"),e=e.querySelector(".js-next-btn"),r=new Swiper(".nobjects-item__preview",{slidesPerView:"auto",spaceBetween:14});new Swiper(".nobjects-item__full",{slidesPerView:1,thumbs:{swiper:r},spaceBetween:10,navigation:{prevEl:t,nextEl:e}})};document.addEventListener("DOMContentLoaded",()=>{var e=document.querySelectorAll(".media-item"),e=(0<e.length&&e.forEach(e=>objectItemInit(e)),Array.from(document.querySelectorAll(".video-block"))),e=(0<e.length&&initVKVideo(e),document.querySelector(".js-open-modal")),t=document.querySelector(".js-modal-feedback"),t=(t&&e&&modalInit(t,e),initProductsGroup(),document.querySelector(".js-company-wrapper")),e=(t&&initCompanyWrapper(t),document.querySelectorAll(".nobjects-item__sliders"));0<e.length&&e.forEach(e=>{reviewsSliderInit(e)})});